...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/logo.png"));
        Image i3 = ic.getImage().getScaledInstance(900, 750,Image.SCALE_DEFAULT);
